        ...
        <>
                ...
                <div className="mx-auto xl:max-w-3xl h-full p-4 flex bg-white rounded-lg shadow overflow-hidden">
                    ...
                    <div className="w-full my-10">
                        <form onSubmit={handleBillFormSubmit}>
                            ...
                            <h1 className="text-2xl font-bold cursor-pointer" onClick={openThirdModal}>Add Bill to :</h1>
                ...
                <div className="fixed inset-0 flex items-center  justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded shadow-lg sm:max-w-lg w-full">
                        <div className='flex items-center justify-between'>
                            ...
                            <p className='mb-2 cursor-pointer'><FaTimesCircle onClick={closeModal} size={25} /></p>
                        </div>
                ...
                <div className="fixed inset-0 flex items-center  justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded shadow-lg sm:max-w-lg w-full">
                        <div className='flex items-center justify-between'>
                            ...
                            <p className='mb-2 cursor-pointer'><FaTimesCircle onClick={closeSecondModal} size={25} /></p>
                        </div>
            ...
            {isThirdModalOpen && (
                <div className="fixed inset-0 flex items-center  justify-center bg-black bg-opacity-50 z-50">
                    <div className="bg-white p-6 rounded shadow-lg sm:max-w-lg w-full">
                        <div className='flex items-center justify-between'>
                            <h2 className="text-2xl font-bold mb-4">Add Bill To</h2>
                            <p className='mb-2 cursor-pointer'><FaTimesCircle onClick={closeThirdModal} size={25} /></p>
                        </div>
                        <form onSubmit={handleThirdModalFormSubmit}>
                            ...
                            <div className="mb-4">
                                <label className="block text-gray-700 text-sm font-semibold mb-2" htmlFor="vatNo">
                                    VAT No
                                </label>
                                <input
                                    className="text-sm bg-gray-200 appearance-none rounded w-full py-2 px-3 text-gray-700 mb-1 leading-tight focus:outline-none focus:shadow-outline h-10"
